...
${OBJECTDIR}/bit_vector.o: bit_vector.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bit_vector.o bit_vector.c

${OBJECTDIR}/generate.o: generate.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/generate.o generate.c
...
${TESTDIR}/tests/generate_list.o: tests/generate_list.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/generate_list.o tests/generate_list.c
...
${OBJECTDIR}/bit_vector_nomain.o: ${OBJECTDIR}/bit_vector.o bit_vector.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bit_vector_nomain.o bit_vector.c;\
	else  \
...
${OBJECTDIR}/generate_nomain.o: ${OBJECTDIR}/generate.o generate.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/generate_nomain.o generate.c;\
	else  \
...
${OBJECTDIR}/heap_nomain.o: ${OBJECTDIR}/heap.o heap.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heap_nomain.o heap.c;\
	else  \
